...
@Component({
    selector: 'app-paseo-new-admin-routed',
    templateUrl: './paseo-new-admin-routed.component.html',
    styleUrls: ['./paseo-new-admin-routed.component.css'],
})
export class PaseoNewAdminRoutedComponent implements OnInit {
    ...
    showModal = (id: number) => {
      ...
      myModalEl.addEventListener('hidden.bs.modal', (event): void => {
        console.log({id})
        this.oRouter.navigate(['/admin/paseo/view/' + id])
      })
      this.myModal.show()
    }
